...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card glass-tile flex flex-col gap-(--card-spacing) overflow-hidden rounded-2xl py-(--card-spacing) text-[13px] text-card-foreground [--card-spacing:--spacing(4)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)] *:[img:first-child]:rounded-t-2xl *:[img:last-child]:rounded-b-2xl",
        className
      )}
      {...props}
    />
